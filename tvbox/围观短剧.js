import { installDrpyRuntime } from '../catLib/ai-js/drpy-runtime.js';
installDrpyRuntime();
...
let rule = {
    ...
    tagsUrl: '/drama/home/shortVideoTags?version_code=1600&os_type=1',
    searchUrl: '/drama/home/search?version_code=1600&os_type=1',
    detailUrl: '/drama/home/shortVideoDetail?version_code=1600&os_type=1'
};
...
async function detail(id) {
    ...
    if (data && data.code === 200 && data.data && Array.isArray(data.data)) {
        ...
        const vod = {
            vod_id: String(id),
            vod_name: data.title || firstEpisode.title || '未知剧名',
            vod_pic: data.vertPoster || firstEpisode.vertPoster || '',
